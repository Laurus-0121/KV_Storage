...
func (db *KvDB) ZAdd(key []byte, score float64, member []byte) error {
...
func (db *KvDB) ZScore(key, member []byte) float64 {
...
func (db *KvDB) ZCard(key []byte) int {
...
func (db *KvDB) ZRank(key, member []byte) int64 {
...
func (db *KvDB) ZRevRank(key, member []byte) int64 {
...
func (db *KvDB) ZIncrBy(key []byte, increment float64, member []byte) (float64, error) {
...
func (db *KvDB) ZRange(key []byte, start, stop int) []interface{} {
...
func (db *KvDB) ZRevRange(key []byte, start, stop int) []interface{} {
...
func (db *KvDB) ZRem(key, member []byte) (ok bool, err error) {
...
func (db *KvDB) ZGetByRank(key []byte, rank int) []interface{} {
...
func (db *KvDB) ZRevGetByRank(key []byte, rank int) []interface{} {
...
func (db *KvDB) ZScoreRange(key []byte, min, max float64) []interface{} {
...
func (db *KvDB) ZRevScoreRange(key []byte, max, min float64) []interface{} {
	if err := db.checkKeyValue(key, nil); err != nil {
		return nil
	}
