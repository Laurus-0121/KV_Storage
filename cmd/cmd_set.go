...
func sAdd(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) <= 1 {
...
func sPop(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sIsMember(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sRandMember(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sRem(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) <= 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sMove(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 3 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sCard(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sMembers(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sUnion(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) <= 0 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sDiff(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) <= 0 {
		err = ErrSyntaxIncorrect
		return
	}
