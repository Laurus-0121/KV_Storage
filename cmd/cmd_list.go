...
func lPush(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) < 2 {
...
func rPush(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) < 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lPop(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func rPop(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lIndex(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 0 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lRem(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 3 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lInsert(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 4 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lSet(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 3 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lTrim(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 3 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lRange(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 3 {
		err = ErrSyntaxIncorrect
		return
	}
...
func lLen(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
