...
func set(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
...
func get(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func setNx(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func getSet(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func appendStr(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func strLen(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func strExists(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func strRem(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func prefixScan(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 3 {
		err = ErrSyntaxIncorrect
		return
	}
...
func rangeScan(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func expire(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 2 {
		err = ErrSyntaxIncorrect
		return
	}
...
func persist(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func ttl(db *KV_Storage.KvDB, args []string) (res string, err error) {
	if len(args) != 1 {
		err = ErrSyntaxIncorrect
	}
